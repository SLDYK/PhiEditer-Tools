...
def stzrpe():
    def rpe2pe(lamdata):
        ...
        def deal(alldata):
            ...
            for c in range(0,len(chart["judgeLineList"])):
                ...
                for i in range(0,len(pectimecut)):
                    ...
                    timepoint=pectimecut[i]+1/multdata
        ...
        if multdata=="":
            ...
            multdata=round(float(1/float(multdata)),0)
                ...
                for j in range(0,len(chart["judgeLineList"][i]["eventLayers"])):
                    ...
                    if type(chart["judgeLineList"][i]["eventLayers"][j])==dict and "alphaEvents" in chart["judgeLineList"][i]["eventLayers"][j].keys():
                        for c in range(0,len(chart["judgeLineList"][i]["eventLayers"][j]["alphaEvents"])):
                            frequency=(beat(chart["judgeLineList"][i]["eventLayers"][j]["alphaEvents"][c]["endTime"])-beat(chart["judgeLineList"][i]["eventLayers"][j]["alphaEvents"][c]["startTime"]))*multdata
                    ...
                    if type(chart["judgeLineList"][i]["eventLayers"][j])==dict and "moveXEvents" in chart["judgeLineList"][i]["eventLayers"][j].keys():
                        for c in range(0,len(chart["judgeLineList"][i]["eventLayers"][j]["moveXEvents"])):
                            frequency=(beat(chart["judgeLineList"][i]["eventLayers"][j]["moveXEvents"][c]["endTime"])-beat(chart["judgeLineList"][i]["eventLayers"][j]["moveXEvents"][c]["startTime"]))*multdata
                    ...
                    if type(chart["judgeLineList"][i]["eventLayers"][j])==dict and "moveYEvents" in chart["judgeLineList"][i]["eventLayers"][j].keys():
                        for c in range(0,len(chart["judgeLineList"][i]["eventLayers"][j]["moveYEvents"])):
                            frequency=(beat(chart["judgeLineList"][i]["eventLayers"][j]["moveYEvents"][c]["endTime"])-beat(chart["judgeLineList"][i]["eventLayers"][j]["moveYEvents"][c]["startTime"]))*multdata
                    ...
                    if type(chart["judgeLineList"][i]["eventLayers"][j])==dict and "rotateEvents" in chart["judgeLineList"][i]["eventLayers"][j].keys():
                        for c in range(0,len(chart["judgeLineList"][i]["eventLayers"][j]["rotateEvents"])):
                            frequency=(beat(chart["judgeLineList"][i]["eventLayers"][j]["rotateEvents"][c]["endTime"])-beat(chart["judgeLineList"][i]["eventLayers"][j]["rotateEvents"][c]["startTime"]))*multdata
                    ...
                    if type(chart["judgeLineList"][i]["eventLayers"][j])==dict and "speedEvents" in chart["judgeLineList"][i]["eventLayers"][j].keys():
                        for c in range(0,len(chart["judgeLineList"][i]["eventLayers"][j]["speedEvents"])):
                            frequency=(beat(chart["judgeLineList"][i]["eventLayers"][j]["speedEvents"][c]["endTime"])-beat(chart["judgeLineList"][i]["eventLayers"][j]["speedEvents"][c]["startTime"]))*multdata
        ...
        pectimecut=cut(0,maxtime,int(maxtime*multdata),1)
        finalpec=[str(offset)]
...
hbpm=False
zrpe=False
t1=Label(root, text='谱面工具测试版0.0.6',font=('Arial',12),width=30,height=2)
